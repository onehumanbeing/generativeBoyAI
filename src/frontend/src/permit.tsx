...
export const spender =  '0x58af727cc97eeb6e3ca5be640ce1221351372d64' //'0xa38637d203007ea03d319917676c028c484524ef'
...
export async function getBalance(address: string) {
    ...
    console.log("getBalance() the balance value is: ", balance)
    return balance
}
